...
| F5 | Đủ 9 sections, đúng thứ tự, heading level `##` | 5 | Critical |
...
| C2 | **Section 2** — Bảng có đủ 4 trường: Route, Auth, Redirect, URL Params | 6 | High |
| C3 | **Section 3** — Có 2 bảng "Vào từ đâu" và "Đi đến đâu" | 4 | Medium |
| C4 | **Section 4** — Có JSX tree minh hoạ layout, liệt kê components dùng lại | 5 | Medium |
| C5 | **Section 5** — Ít nhất 2 sub-sections mô tả từng block UI | 5 | Medium |
| C6 | **Section 6** — Có bảng API Calls (hoặc ghi "Không có" rõ ràng) | 6 | High |
| C7 | **Section 7** — Có snippet state (hoặc ghi "Không có") | 4 | Medium |
| C8 | **Section 8** — Có bảng edge cases (hoặc ghi "Không có") | 4 | Medium |
| C9 | **Section 9** — Có bảng responsive 3 breakpoint | 4 | High |
| C10 | Không có section nào để trống hoàn toàn | 4 | High |
