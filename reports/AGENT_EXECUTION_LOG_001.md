...
- **Task**: doc-be-create-and-review cho chức năng quản lý bài viết (API06-API13)
...
- **Status**: SUCCESS
- **Notes**: Tài liệu phản ánh contract code hiện tại; residual findings: BE response chưa có `messageId`, update chưa validate/whitelist body, delete đang hard delete dù DB schema có soft-delete columns, admin list chưa pagination/filter.
