    ...
    return (
      <div className="bg-gray-50 min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link to="/" className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-blue-600 hover:bg-blue-700 transition-colors">
            Quay lại trang chủ
          </Link>
        </div>
      </div>
            ...
            {post.tags && post.tags.length > 0 && (
              <div className="mt-12 pt-8 border-t border-gray-100">
                <div className="flex flex-wrap gap-2">
                  {post.tags.map(tag => (
                    <Link key={tag.id} to={`/tag/${tag.slug}`} className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-medium hover:bg-gray-200 cursor-pointer transition-colors">
                      #{tag.name}
                    </Link>
                  ))}
                </div>
            ...
            <div className="sticky top-8">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-100">
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <button className="w-full py-2 px-4 bg-white border border-gray-300 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                    Xem tất cả bài viết
                  </button>
                </div>
              </div>
